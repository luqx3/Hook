...
//                dto.list.addAll(ChatMsgReader.getInstance(getApplicationContext()).uploadEnMicroMsgDB("0"));
...
//                emitter.onNext(ChatMsgReader.getInstance(getApplicationContext()).uploadEnMicroMsgDB("0"));
//                emitter.onComplete();
//
//            }
...
//                emitter.onNext(ChatMsgReader.getInstance(getApplicationContext()).queryEnMicroMsgDB());
//                emitter.onComplete();
//
//            }
//        })
